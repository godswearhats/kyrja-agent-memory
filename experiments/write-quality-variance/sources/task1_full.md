...
**Tool [Edit]:** `experiments/phase2-utility/worktrees/bootstrap_where_keep_attrs_add/xarray/core/computation.py`
  ```
  - def where(cond, x, y):
...
**Tool result:** The file experiments/phase2-utility/worktrees/bootstrap_where_keep_attrs_add/xarray/core/computation.py has been updated successfully. (file state is current in your context — no need to Read it back)
...
**Tool [Bash]:** `which python && ls experiments/phase2-utility/worktrees/bootstrap_where_keep_attrs_add/ | head -20 && find / -name "pytest" -type f 2>/dev/null | head -3`
...
**Tool [Bash]:** `experiments/phase2-utility/.venv/bin/python -m pytest xarray/tests/test_computation.py -k "where" -x 2>&1 | tail -30`

**Tool result:** ============================= test session starts ==============================
platform linux -- Python 3.12.13, pytest-7.4.4, pluggy-1.6.0
rootdir: experiments/phase2-utility/worktrees/bootstrap_where_keep_attrs_add

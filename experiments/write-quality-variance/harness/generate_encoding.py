#!/usr/bin/env python3
"""Generate a memory encoding by running Claude in -p mode over a (prompt, source) pair.

Variants:
    A — canonical briefing prompt over full Task 1 transcript
    B — summary-framing prompt over full Task 1 transcript
    C — structured-slot prompt over full Task 1 transcript
    D — canonical briefing prompt over truncated Task 1 transcript
    (E — deferred)

Usage:
    generate_encoding.py <variant_letter>
"""
...
VARIANTS = {
    "A": {"prompt": "A_briefing_1200.md", "source": "task1_full.md"},
    "B": {"prompt": "B_summary_1200.md", "source": "task1_full.md"},
    "C": {"prompt": "C_structured_1200.md", "source": "task1_full.md"},
    "D": {"prompt": "A_briefing_1200.md", "source": "task1_truncated.md"},
}
